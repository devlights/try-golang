...
import (
	...
	// Compile Error: use of internal package github.com/devlights/try-golang/examples/basic/internalsub2 not allowed
	// "github.com/devlights/try-golang/examples/basic/internalsub2"
)
